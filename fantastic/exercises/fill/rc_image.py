...
class RemplirClavierImage(Fill):
    """exercises consisting of images to describe usually"""
    ...
    def __init__(self, json_path: str, config: ConfigParser) -> None:
        Fill.__init__(
            ...
            config,
            template_name="fill",
            output_folder_name="remplir_clavier_image",
        )
    ...
    def adapt(self):
        """specific adapatation for rc image"""
        super().adapt_html()
        return self
